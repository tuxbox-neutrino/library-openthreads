...
public:
	...
	sprintf(tmp, "StackSize: %d\n", getStackSize());
        ...
        notifyObserversStarted(getProcessId());
        notifyObserversMessage(getProcessId(), "This is a thread message.");
	notifyObserversMessage(getProcessId(), tmp);
	...
	notifyObserversMessage(getProcessId(), "Finished my work");
	...
	notifyObserversFinished(getProcessId());
